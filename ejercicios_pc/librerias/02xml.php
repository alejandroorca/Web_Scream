...
$department->addChild('title', 'Implantación de sistemas operativos');
...
$department->addChild('last_name', 'López Quintero');
$department->addChild('course');
...
$department->addChild('course');
$department->addAttribute('number', 'SGBD');
$department->addAttribute('enrollment', '999');
$department->addChild('professor');
$department->addChild('first_name', 'José Manuel');
